...
/*   Updated: 2026/05/11 19:26:19 by jose-ara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_const_vals const_val = game->const_values;
	if (rc->coll_tex == DOOR_TEX)
		return (game->wall_text.door_tex);
	if (rc->hor_ver == 1)
	{
		if (rc->ray_angle > const_val.rad_180_deg && rc->ray_angle < const_val.rad_360_deg)
